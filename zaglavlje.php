					...
					case $trenutna:
						switch($prijavljen_tip>=0) {
							case 'true':
								...
								if($trenutna=="index.php")echo ' id="poveznica"';
								echo ">POČETNA  </a><br/>";
								echo '<a href="korisnici.php"';
								if($trenutna=="korisnici.php")echo ' id="poveznica"';
								echo ">KORISNICI  </a><br/>";
								echo '<a href="pjesme.php"';
								if($trenutna=="pjesme.php")echo ' id="poveznica"';
								echo ">PJESME  </a><br/>";
								echo '<a href="kupnja.php"';
								if($trenutna=="kupnja.php")echo ' id="poveznica"';
								echo ">KUPNJA  </a><br/>";
								echo '<a href="o_autoru.html"';
								if($trenutna=="o_autoru.html")echo ' id="poveznica"';
								echo ">AUTOR  </a><br/>";
							...
							default:
								...
								if($trenutna=="o_autoru.php")echo ' id="poveznica"';
								echo ">AUTOR  </a><br/>";
								echo "Trenutna lokacija: ".$trenutna."<br/>";
								break;
						}
